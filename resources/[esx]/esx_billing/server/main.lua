...
ESX.RegisterServerCallback('esx_billing:getBills', function(source, cb)
	...
	exports.ghmattimysql:scalar('SELECT amount, id, label FROM billing WHERE identifier = @identifier', {
...
ESX.RegisterServerCallback('esx_billing:payBill', function(source, cb, billId)
	...
	exports.ghmattimysql:scalar('SELECT sender, target_type, target, amount FROM billing WHERE id = @id', {
		['@id'] = billId
	}, function(result)
		if result[1] then
